 ...
 * chatbot: it recognises time windows, categories and people, and answers the
 * three questions people actually ask their expense tracker.
 *
...
/**
 * @returns {{text: string, amountMinor?, category?, person?, from?, to?}} — a
 * one-line answer, plus the filter that produced it so the UI can offer "see
 * the entries".
 */
